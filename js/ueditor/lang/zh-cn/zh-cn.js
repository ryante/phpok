...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'music':'音樂','inserttable':'插入表格','drafts': '從草稿箱載入', 'charts': '圖表','insertpbefore':'前插入段落','insertpafter':'後插入段落'
    },
    'insertorderedlist':{
        'num':'1,2,3...',
        'num1':'1),2),3)...',
    ...
    'insertimage':{
        'static':{
            ...
            'searchType':{'title':"圖片型別", 'options':["桌布", "表情", "頭像","新聞"]}, //select的option
    ...
    'searchreplace':{
        'static':{
            ...
            lang_search2:"查詢",
            lang_replace:"替換",
            lang_searchReg:'支援正則表示式，新增前後斜槓標示為正則表示式，例如“/表示式/”',
            lang_searchReg1:'支援正則表示式，新增前後斜槓標示為正則表示式，例如“/表示式/”',
    ...
    'snapscreen':{
        'static':{
            lang_showMsg:"截圖功能需要首先安裝UEditor截圖外掛！ ",
            lang_download:"點此下載",
            lang_step1:"第一步，下載UEditor截圖外掛並執行安裝。",
