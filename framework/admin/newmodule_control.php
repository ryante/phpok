...
class newmodule_control extends phpok_control
{
	private $popedom;
	...
	**/
	public function field_create_f()
	{
		...
		$this->view('module_field_create_new');
	}
	...
	**/
	...
	public function field_edit_f()
	{
		...
		$this->assign('m_rs',$m_rs);
		$this->assign("id",$id);
		$this->view("module_field_set_new");
	}
